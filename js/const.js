...
export const BATTLE_STATUSES = [
    ...
    },
    {
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["atk"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["atk"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["atk"]}は元に戻った。`},
    },
    {
        id: "def",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["def"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["def"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["def"]}は元に戻った。`},
    },
    {
        id: "spd",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["spd"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["spd"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["spd"]}は元に戻った。`},
    },
    {
        id: "dex",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["dex"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["dex"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["dex"]}は元に戻った。`},
    },
    {
        id: "int",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["int"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["int"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["int"]}は元に戻った。`},
    },
    {
        id: "hit",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["hit"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["hit"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}は元に戻った。`},
    },
    {
        id: "dodge",
        icon: "⬆︎",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["dodge"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["dodge"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}は元に戻った。`},
    },
    {
        id: "critical",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["critical"]}が上がった。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["critical"]}が下がった。`},
        subMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}は元に戻った。`},
    },
    {
        id: "multiAction",
        ...
        sub_finish_text: "",
        exec_timing: "",
        addMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}が増えた。`},
        addDownMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}が減った。`},
        subMessageGen: (name) => {return `${name} の${LABEL["multiAction"]}は元に戻った。`},
    },
]
